    ...
    function EmployeeComponent(dataService, translateService) {
        ...
        this.validateEmployee = function () {
            ...
            if (!_this.employee.lastName) {
                _this.errorMap.lastName = true;
                return false;
            }
            else {
                delete _this.errorMap.lastName;
            }
            if (!_this.employee.gender) {
                _this.errorMap.gender = true;
                return false;
            }
            else {
                delete _this.errorMap.gender;
            }
            if (!_this.employee.dateOfBirth) {
                _this.errorMap.dateOfBirth = true;
                return false;
            }
            else {
                delete _this.errorMap.dateOfBirth;
            }
            if (!_this.employee.department) {
                _this.errorMap.department = true;
                return false;
            }
            else {
                delete _this.errorMap.department;
            }
            return true;
        };
        ...
        this.parseText = function (key) {
            if (_this.employee[key] && _this.employee[key].trim().length > 0) {
                delete _this.errorMap[key];
            }
        };
        this.isError = function () { return Object.keys(_this.errorMap).length > 0; };
